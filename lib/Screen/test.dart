...
//   }
//
//   /// Initialize FaceCamera when entering CameraScreen
//   Future<void> _initializeFaceCamera() async {
//     await FaceCamera.initialize();
//     setState(() {
//       _isCameraInitialized = true; // Update UI after initialization
//     });
//
...
//     return Scaffold(
//       appBar: AppBar(title: const Text('Face Camera Example')),
...
//         if (!face.wellPositioned) return _message('Center your face in the square');
    ...
    if (actionCompleted) {
      ...
      if (currentActionIndex >= challengeActions.length) {
        ...
        if (mounted) {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => SkinAnalyzerScreen()),
          );
          print("object");
